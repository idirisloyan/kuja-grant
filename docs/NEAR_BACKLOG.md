...
Moved to [PROXIMATE_BACKLOG.md](PROXIMATE_BACKLOG.md) in the
2026-06-30 backlog reorg. This file is NEAR-tenant-only; see
[BACKLOG.md](BACKLOG.md) for the index of all backlogs.
