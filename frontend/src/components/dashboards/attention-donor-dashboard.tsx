...
import { DecisionAgingCard } from '@/components/dashboards/decision-aging-card';
import { GrantsByStatusCard } from '@/components/dashboards/grants-by-status-card';
...
import { MedianFundedAmountCard } from '@/components/dashboards/median-funded-amount-card';
...
import { ApplicantsThisQuarterStat } from '@/components/dashboards/applicants-this-quarter-stat';
import { GrantsFundedYtdCard } from '@/components/dashboards/grants-funded-ytd-card';
import { ActiveReviewerPanelStat } from '@/components/dashboards/active-reviewer-panel-stat';
import { AvgReviewerScoreStat } from '@/components/dashboards/avg-reviewer-score-stat';
import { AppsYoyStat } from '@/components/dashboards/apps-yoy-stat';
import { GrantsPublishedMonthStat } from '@/components/dashboards/grants-published-month-stat';
import { DaysSinceLastGrantStat } from '@/components/dashboards/days-since-last-grant-stat';
import { MedianGrantFundingStat } from '@/components/dashboards/median-grant-funding-stat';
import { OpenGrantsFundingStat } from '@/components/dashboards/open-grants-funding-stat';
import { ApplicationsWithoutReviewerStat } from '@/components/dashboards/applications-without-reviewer-stat';
...
import { AppsOpen60dStat } from '@/components/dashboards/apps-open-60d-stat';
...
import { EoiConversionStat } from '@/components/dashboards/eoi-conversion-stat';
import { AppsAwaitingFirstReviewStat } from '@/components/dashboards/apps-awaiting-first-review-stat';
import { DraftGrantsCountStat } from '@/components/dashboards/draft-grants-count-stat';
import { FirstTimeNgosMonthStat } from '@/components/dashboards/first-time-ngos-month-stat';
import { EoiPerGrantMeanStat } from '@/components/dashboards/eoi-per-grant-mean-stat';
...
export function AttentionDonorDashboard() {
  ...
  return (
    <PageShell>
      ...
      <ReviewPipelineCard />
      <AppsByMonthCard />
      <MedianFundedAmountCard />
      <AppsPerGrantCard />
      <AppsThisWeekCard />
      <UnassignedReviewsCard />
      <ApprovalRateCard />
      <ApplicantsThisQuarterStat />
      <GrantsFundedYtdCard />
      <ActiveReviewerPanelStat />
      <AvgReviewerScoreStat />
      <AppsYoyStat />
      <GrantsPublishedMonthStat />
      <DaysSinceLastGrantStat />
      <MedianGrantFundingStat />
      <OpenGrantsFundingStat />
      <ApplicationsWithoutReviewerStat />
      ...
      <EoiConversionStat />
      <AppsAwaitingFirstReviewStat />
      <DraftGrantsCountStat />
      <FirstTimeNgosMonthStat />
      <EoiPerGrantMeanStat />
