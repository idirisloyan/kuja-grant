...
const PROXIMATE_OB_ACTIONS: NavAction[] = [
  ...
  { id: 'prx-rounds',        label: 'Funding rounds', labelKey: 'nav.rounds_disbursements', description: 'Funding rounds',      descKey: 'nav.desc_funding_rounds',      href: '/proximate/rounds',           icon: BarChart3,       roles: [], keywords: ['funding', 'round'] },
  ...
  { id: 'prx-disbursements', label: 'Disbursements',      labelKey: 'nav.all_disbursements',    description: 'Money out + reports', descKey: 'nav.desc_money_out',           href: '/proximate/disbursements',    icon: FileText,        roles: [], keywords: ['payment', 'report'] },
